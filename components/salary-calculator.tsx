    ...
    <Card>
      ...
      <CardContent>
          <Tabs
            value={activeTab}
            onValueChange={(value) => {
              if (value === "result" && !(result || inflationResult)) {
                // Prevent switching to "result" tab if no results
                return;
              }
              setActiveTab(value);
            }}
          >
            <TabsList>
              <TabsTrigger value="input">Datos</TabsTrigger>
              <TabsTrigger value="result" disabled={!(result || inflationResult)}>
                Resultados
              </TabsTrigger>
            </TabsList>
